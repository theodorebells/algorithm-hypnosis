        ...
        <section className="py-24 px-4 md:px-8 relative">
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Glassmorphism Panel for "Perfect For" */}
                    <div className="glass-panel p-8 rounded-3xl border border-white/10 hover:bg-white/5 transition-all duration-300 group relative overflow-hidden">
                    ...
                    {/* Glassmorphism Panel for "Not For" */}
                    <div className="glass-panel p-8 rounded-3xl border border-white/10 hover:bg-white/5 transition-all duration-300 group relative overflow-hidden">
